...
plt.rcParams['figure.subplot.top'] = 0.75
plt.rcParams['figure.subplot.wspace'] = 0.2
plt.rcParams['figure.subplot.hspace'] = 0.2

def plot_branching(branch_glob: list, color_plot: str, h_string: str, N: int, seconds: int):
    ...
    plt.ylabel(r"$m_t$", fontsize=label_fontsize, fontweight=500, labelpad=20, rotation=0)  
    ...
    #plot the fucking title
    plt.title(r'$\frac{h}{r^*} = $' + h_string, color=color_plot, fontsize=title_fontsize, pad=20, fontweight='bold')
